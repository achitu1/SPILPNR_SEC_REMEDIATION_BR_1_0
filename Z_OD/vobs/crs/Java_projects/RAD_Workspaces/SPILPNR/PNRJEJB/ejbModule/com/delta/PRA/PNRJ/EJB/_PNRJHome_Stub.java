...
public class _PNRJHome_Stub extends Stub implements PNRJHome {
    
    private static final String[] _type_ids = {
        "RMI:com.delta.PRA.PNRJ.EJB.PNRJHome:0000000000000000", 
    ...
    public PNRJ create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (PNRJ) in.read_Object(PNRJ.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.delta.PRA.PNRJ.EJB.PNRJHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    PNRJ result = ((com.delta.PRA.PNRJ.EJB.PNRJHome)so.servant).create();
                    return (PNRJ)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());

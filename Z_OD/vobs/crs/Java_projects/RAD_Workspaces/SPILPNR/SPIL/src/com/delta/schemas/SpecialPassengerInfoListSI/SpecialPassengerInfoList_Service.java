...
@WebServiceClient(name = "SpecialPassengerInfoList", targetNamespace = "http://soa.delta.com/specialpassengerinfolist", wsdlLocation = "WEB-INF/wsdl/SpecialPassengerInfoList_concrete_SI.wsdl")
    ...
    extends Service
{
    ...
    static {
            SPECIALPASSENGERINFOLIST_WSDL_LOCATION = com.delta.schemas.SpecialPassengerInfoListSI.SpecialPassengerInfoList_Service.class.getResource("/WEB-INF/wsdl/SpecialPassengerInfoList_concrete_SI.wsdl");
        WebServiceException e = null;
        if (SPECIALPASSENGERINFOLIST_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'WEB-INF/wsdl/SpecialPassengerInfoList_concrete_SI.wsdl' wsdl. Place the resource correctly in the classpath.");
        }

...
public class PNRJ002_LookupPassengerDetailShowAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, 
			...
			Logger.log(PNRJ002_LookupPassengerDetailShowAction.class, Logger.LEVEL_DEBUG, "Start of execute in PNRJ002_LookupPassengerDetailShowAction");
...
//					}
			...
			/*catch (NamingException ne) {
				Logger.log(PNRJ002_LookupPassengerDetailShowAction.class, Logger.LEVEL_ERROR, 
				...
				Logger.log(PNRJ002_LookupPassengerDetailShowAction.class, Logger.LEVEL_ERROR, dbe.getMessage());
				...
				Logger.log(PNRJ002_LookupPassengerDetailShowAction.class, Logger.LEVEL_ERROR, e.getMessage());
				errorException.add(ActionErrors.GLOBAL_ERROR, 

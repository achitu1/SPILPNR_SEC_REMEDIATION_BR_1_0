...
public class PNRJ002_LookupFlightDetailShowAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, 
			...
			Logger.log(PNRJ002_LookupFlightDetailShowAction.class, Logger.LEVEL_DEBUG, "Start of execute in PNRJ002_LookupFlightDetailShowAction");
...
//					}
			...
			/*catch (NamingException ne) {
				...
				Logger.log(PNRJ002_LookupFlightDetailShowAction.class, Logger.LEVEL_ERROR, e.getMessage());

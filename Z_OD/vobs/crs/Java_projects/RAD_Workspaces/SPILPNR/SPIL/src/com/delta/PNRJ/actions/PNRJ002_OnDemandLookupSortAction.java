...
public class PNRJ002_OnDemandLookupSortAction {
	 ...
	 */
	  ...
	  public ActionForward execute(ActionMapping mapping, 
			  ...
			  Logger.log(PNRJ002_OnDemandLookupSortAction.class, Logger.LEVEL_DEBUG, "Start of execute in PNRJ002_OnDemandLookupSortAction");
			  ...
			  try{
				  ...
				  Logger.log(PNRJ002_OnDemandLookupSortAction.class, Logger.LEVEL_ERROR, e.getMessage());

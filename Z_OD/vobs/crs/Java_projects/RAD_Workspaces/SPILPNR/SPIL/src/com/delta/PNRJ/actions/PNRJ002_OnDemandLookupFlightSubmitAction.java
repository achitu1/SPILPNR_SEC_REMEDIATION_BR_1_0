...
public class PNRJ002_OnDemandLookupFlightSubmitAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, 
			...
			Logger.log(PNRJ002_OnDemandLookupFlightSubmitAction.class, Logger.LEVEL_DEBUG, "Start of execute in PNRJ002_OnDemandLookupFlightSubmitAction");
			...
			Logger.log(PNRJ002_OnDemandLookupFlightSubmitAction.class, Logger.LEVEL_DEBUG, "Formatted Travel Date = [" + frm.getTravelDate() + "]");
			...
			try{
				...
				Logger.log(PNRJ002_OnDemandLookupFlightSubmitAction.class, Logger.LEVEL_DEBUG, "In OnDemandLookupFlightSubmitAction");

				Logger.log(PNRJ002_OnDemandLookupFlightSubmitAction.class, Logger.LEVEL_DEBUG, "Flight Number is:" + frm.getFlightNumber());

				Logger.log(PNRJ002_OnDemandLookupFlightSubmitAction.class, Logger.LEVEL_DEBUG, "Travel Date is:" + frm.getTravelDate());

				Logger.log(PNRJ002_OnDemandLookupFlightSubmitAction.class, Logger.LEVEL_DEBUG, "Airline Code is:" + frm.getAirlineCode());

				Logger.log(PNRJ002_OnDemandLookupFlightSubmitAction.class, Logger.LEVEL_DEBUG, "Timestamp is:" + frm.getTimeStamp());
			...
			//on demand begin
				frm.setSelTimeStamp(frm.getSelTimeStamp());
				...
				Logger.log(PNRJ002_OnDemandLookupFlightSubmitAction.class, Logger.LEVEL_ERROR, e.getMessage());

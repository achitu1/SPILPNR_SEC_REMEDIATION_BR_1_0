...
package com.delta.schemas.pci.v1.pcitokenmgrresp;
...
import com.delta.schemas.pci.v1.dictionary.DictionaryType;
import com.delta.schemas.pci.v1.pciitemstat.ArrayOfPciTokItemStatus;
...
public class PciTokMgrResponse {
    ...
    @XmlElement(name = "OperationTimestamp", required = true)
    ...
    @XmlElement(name = "AdditionalProviderInfo", required = true)

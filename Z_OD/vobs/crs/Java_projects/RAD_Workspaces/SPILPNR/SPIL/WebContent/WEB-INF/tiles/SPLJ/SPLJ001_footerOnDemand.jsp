...
<%
	...
	String path = contextpath + "/PNRJ/redirectApp.do";		String spilPath = contextpath+"/SPLJ/FlightInquiry.do";
%>
...
<table width="950" cellpadding="0" cellspacing="0" border="0"
	...
	<tr>
		...
		<td align="right">					<logic:present role="authorizedUsers">				<html:link href="<%=spilPath%>" target="blank"> SPIL</html:link>&nbsp;|&nbsp; 			</logic:present> <logic:notPresent role="authorizedUsers">						SPIL&nbsp;|&nbsp; 			</logic:notPresent>						<logic:present role="queryonly,querycc">

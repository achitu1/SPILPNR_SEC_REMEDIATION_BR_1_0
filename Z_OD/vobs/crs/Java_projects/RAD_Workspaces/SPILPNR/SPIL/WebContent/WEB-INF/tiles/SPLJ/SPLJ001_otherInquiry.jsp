...
//    tmp3.style.display = 'block';
 ...
 //   tmp5.style.display = 'block';
  ...
  function resetThis(){
  		...
  		document.forms[0].action="<%=contextPath%>/SPLJ/OtherInquiry.do"	               
...
document.forms[0].action="<%=contextPath%>/SPLJ/OtherInquirySubmit.do"	
document.forms[0].submit();
}
</script>
</head>
<html:form action="/SPLJ/OtherInquirySubmit.do" focus="ticketNumber" method="post">
	...
	<tbody>
		...
		<tr>
			<td>&nbsp;</td>
				...
				<!--list header start-->
	<logic:equal property="rowSelected" value="true" name="otherInquiryForm">
	<tr><td align="right">
		...
		<logic:equal name="otherInquiryForm" property="flagList" value="true">	
...
<logic:present name="otherInquiryForm" property="selectList">
<logic:empty name="otherInquiryForm" property="selectList">	
<font color="red">DL SPILs from 03/09/2011 through current (Cancel SPILs from 09/23/2012) &nbsp;&nbsp;&nbsp; NW SPILs Thru 01/30/2010</font>			
...
<logic:notEmpty name="otherInquiryForm" property="selectList"><table width="100%"><tr><td width="70%">
	<font color="red">DL SPILs from 03/09/2011 through current (Cancel SPILs from 09/23/2012) &nbsp;&nbsp;&nbsp; NW SPILs Thru 01/30/2010</font>
	</td><td>		
	...
	<bean:write property="pnrCount" name="otherInquiryForm"/>&nbsp;rows returned.
<div id="tableContainer" style="overflow:auto; height:227px; width:100%;border:1px solid #B1B4C5;">	
		<display:table name="otherInquiryForm.selectList" class="listTable" requestURI="/SPLJ/OtherInquirySubmit.do" id="scrollTable" cellpadding="0" cellspacing="1" style="text-align:center; width:100%; background-color: #FFFFFF;" decorator="com.delta.SPLJ.decorators.SPLdecorator"> 
...
<table border="0" width="100%" style="text-align:center;" cellpadding="0" cellspacing="0" class="sub_table">
			...
			<tr style="padding-top:10px;">
				...
				<b>	<bean:message key="spl.selected.field.SEAT" /> : <font color="#336699"><bean:write property="selRowSeat" name="otherInquiryForm" /></font>&nbsp;&nbsp;&nbsp;&nbsp;
				<bean:message key="spl.selected.field.PASSENGER" /> : <font color="#336699"><bean:write property="selPassenger" name="otherInquiryForm" /></font>&nbsp;&nbsp;&nbsp;&nbsp;
				<bean:message key="spl.selected.field.CUST_ID" /> : <font color="#336699"><bean:write property="customerID" name="otherInquiryForm" /></font>&nbsp;&nbsp;&nbsp;&nbsp;
				<bean:message key="spl.selected.field.CNCLIND" /> : <font color="#336699"><bean:write property="cnclInd" name="otherInquiryForm" /></font>
			</b></td>
			</tr>	
		...
		<tr style="padding-top:10px;padding-left:16px;">
			<td colspan="11" >
				<table align="left" border="0" width="98%">
					...
					<tr>
						<td align="left" style="padding-left:18px;"><html:text size="10" property="flightNum" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;"/></td>
						<td align="left" style="padding-left:2px;padding-right:2px;"><html:text property="depDate" size="14" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;"/></td>
						<td align="left" style="padding-left:6px;padding-right:1px;"><html:text property="boardPoint" size="6" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>
						<td align="left" style="padding-left:6px;padding-right:1px;"><html:text property="offPoint" size="6" name="otherInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="left" style="padding-left:8px;padding-left:6px;"><html:text property="class1" size="6" name="otherInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="left" ><html:text property="bookedClass" size="3" name="otherInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="left" ><html:text property="flownClass" size="3" name="otherInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>			
						<td align="left" ><html:text property="type" size="3" name="otherInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="center"><html:text property="conFrom1" size="5" name="otherInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="center"><html:text property="conFrom2" size="5" name="otherInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="center"><html:text property="conTo1" size="5" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>
						<td align="center"><html:text property="conTo2" size="5" name="otherInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr style="padding-top:10px;padding-left:16px;"><td colspan="11"><table align="left" border="0" width="98%">
			...
			<tr>
				<td align="left" valign="top" style="padding-left:15px;"><html:text property="pnr" size="10" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>
				<td colspan="2"  valign="top" style="padding-left:17px;"><html:text property="pnrCreateDate" size="14" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>
				<td colspan="2"  valign="top" style="padding-left:8px;"><html:text property="tktNumber" size="14" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>
				<td colspan="2"  valign="top" style="padding-left:15px;"><html:text property="ticketIssueDate" size="14" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				<td valign="top" style="padding-left:15px;"><html:text property="checkinDate" size="12" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				<td valign="top" style="padding-left:15px;"><html:text property="checkinTime" size="12" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
					<td valign="top" style="padding-left:15px;"><html:text property="onBoardDate" size="12" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				<td valign="top" style="padding-left:15px;"><html:text property="onBoardTime" size="12" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
			</table></td></tr>
			...
			<tr>
				<td valign="top" style="padding-left:15px;"><html:text property="frequentFlierAirline" size="10" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				<td valign="top" style="padding-left:18px;padding-right:10px"><html:text property="frequentFlierId" size="14" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				<td valign="top" colspan="2" align="left" style="padding-left:5px;padding-right:10px"><html:text property="frequentFlierTier" size="30" name="otherInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				...
				<logic:present name="otherInquiryForm" property="remList">
				<logic:notEmpty name="otherInquiryForm" property="remList">		
				<td colspan="7" align="left" style="padding-left:5px;">
				<table class="filter"><logic:iterate name="otherInquiryForm" property="remList" id="remList">
				...
				<logic:notPresent name="otherInquiryForm" property="remList">
				<td colspan="7" align="left" style="padding-left:5px;">
				<table class="filter">
...
<html:hidden property="selSeqNum" name="otherInquiryForm"/>
<html:hidden property="selLegOrigApCode" name="otherInquiryForm"/>
<html:hidden property="selRowSeat" name="otherInquiryForm"/>
<html:hidden property="selPassenger" name="otherInquiryForm"/>
<html:hidden property="flightNumber" name="otherInquiryForm"/>
<html:hidden property="selPnr" name="otherInquiryForm"/>
<html:hidden property="rowSelected" name="otherInquiryForm" value="false" />
<html:hidden property="localDepartureDate" name="otherInquiryForm"/>
<html:hidden property="selAirlineCode" name="otherInquiryForm"/>
<html:hidden property="download" name="otherInquiryForm" value="false" />
</div>

<!-- for scroll List printing -->	
	<div id="printListArea" style="width:100%;display:none;">	
		<display:table name="otherInquiryForm.selectList" requestURI="/SPLJ/OtherInquirySubmit.do" cellpadding="0" cellspacing="1" style="text-align:center; width:100%; background-color: #FFFFFF;font-size: 6pt;" decorator="com.delta.SPLJ.decorators.SPLdecorator"> 
	    <display:setProperty name="locale.provider" value="org.displaytag.localization.I18nStrutsAdapter"/> 
	...
	<logic:present name="otherInquiryForm" property="selectList">
	<logic:notEmpty name="otherInquiryForm" property="selectList">		
	<logic:notEqual property="selPassenger" value="" name="otherInquiryForm">
		<script>
		function scroll(){

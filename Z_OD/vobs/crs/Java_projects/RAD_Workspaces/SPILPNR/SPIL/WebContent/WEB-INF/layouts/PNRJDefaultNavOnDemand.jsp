...
<% String contextpath=request.getContextPath(); 
	...
	String path = contextpath+"/SPLJ/OnDemandFlightInquiry.do";%>
...
<!-- On Demand Changes begin 7/20/16 -->
<center>

<tiles:insert attribute="onDemandWindow" />

</center>

<br>
<!-- On Demand Changes ends 7/20/16 -->

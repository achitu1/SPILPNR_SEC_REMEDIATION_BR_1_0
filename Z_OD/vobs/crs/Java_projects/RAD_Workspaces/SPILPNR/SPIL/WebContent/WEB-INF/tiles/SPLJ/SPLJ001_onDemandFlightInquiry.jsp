...
obj.value=val.toUpperCase();
  ...
  function resetThis(){
  		...
  		document.forms[0].action="<%=contextPath%>/SPLJ/OnDemandFlightInquiry.do";	               
...
function paintMouseEvents(tableId) {
	...
	//				alert("values 17 --- "+this.getElementsByTagName("td")[17].innerText);
					//console.log( "TIMESTAMP-STRING SEARCH " + tsstring );
					//var timeStamp = new date(date.parse(this.getElementsByTagName("td")[16]));
		//			alert("values 16 --- "+this.getElementsByTagName("td")[16].innerText);
		//			alert("tsstring 16 --- "+tsstring);
					
					//console.log( "PNR NUM SEARCH " + pnrnum );
					// var timeStamp = this.getElementsByTagName("timeStamp")[0].value;
...
document.forms[0].action="<%=contextPath%>/SPLJ/OnDemandFlightInquirySubmit.do";	
...
<html:form	action="/SPLJ/OnDemandFlightInquirySubmit.do" method="post">
...
<div id="main">
			...
			<table border="0" cellpadding="0" cellspacing="0" id="tabTable">
				...
				<tbody>
					...
					<tr>
						...
						<td><html:img border="0" page="/images/flight_inquiry_ondemand_off.png"
						
							style="cursor:hand;" onclick="openURLSPIL('FlightInquiryOnDemand.do');" /></td>
						...
						<td><html:img border="0" page="/images/passenger_inquiry_off.gif"
							...
							style="cursor:hand;" onclick="openURLSPIL('OnDemandPassengerInquiry.do');" /></td>

						<td><html:img border="0" page="/images/frequent_inquiry_off.gif"

							style="cursor:hand;" onclick="openURLSPIL('OnDemandFrequentFlierInquiry.do');" /></td>
	...
	<logic:equal property="rowSelected" value="true" name="onDemandFlightInquiryForm">
...
<!-- 			<font color="red">DL SPILs from 03/09/2011 through current (Cancel SPILs from 09/23/2012) &nbsp;&nbsp;&nbsp; NW SPILs Thru 01/30/2010</font> -->
				...
				<font color="red"><bean:write property="displayMessage" name="onDemandFlightInquiryForm"/></font>
		...
		<logic:equal name="onDemandFlightInquiryForm" property="flagList" value="true">	
	...
	<logic:present name="onDemandFlightInquiryForm" property="selectList">

	<logic:empty name="onDemandFlightInquiryForm" property="selectList">
...
<!-- on demand begin -->
		<!-- 		<th style="text-align:center;width:3%"><bean:message key="spl.default.header.field.TimeStamp"/></th>    -->
		<!-- on demand end -->
			</tr>
	...
	<logic:notEmpty name="onDemandFlightInquiryForm" property="selectList"><table width="100%"><tr><td width="70%">
	...
	<bean:write property="pnrCount" name="onDemandFlightInquiryForm"/>&nbsp;rows returned.

	<div id="tableContainer" style="overflow-y:auto;height:227px; width:100%;border:1px solid #B1B4C5;" class="printstart">	

		<display:table name="onDemandFlightInquiryForm.selectList" class="listTable" requestURI="/SPLJ/OnDemandFlightInquirySubmit.do" id="scrollTable" cellpadding="1" cellspacing="1" style="text-align:center; width:100%; background-color: #FFFFFF;" decorator="com.delta.SPLJ.decorators.SPLdecorator" > 
 ...
 --%>	    	
	...
	<table border="0" width="100%" style="text-align:center;" cellpadding="0" cellspacing="0" class="sub_table">
			...
			<tr style="padding-top:10px;">
				...
				<b>	<bean:message key="spl.selected.field.SEAT" /> : <font color="#336699"><bean:write property="selRowSeat" name="onDemandFlightInquiryForm" /></font>&nbsp;&nbsp;&nbsp;&nbsp;

				<bean:message key="spl.selected.field.PASSENGER" /> : <font color="#336699"><bean:write property="selPassenger" name="onDemandFlightInquiryForm" /></font>&nbsp;&nbsp;&nbsp;&nbsp;

				<bean:message key="spl.selected.field.CUST_ID" /> : <font color="#336699"><bean:write property="customerID" name="onDemandFlightInquiryForm" /></font>&nbsp;&nbsp;&nbsp;&nbsp;

				<bean:message key="spl.selected.field.CNCLIND" /> : <font color="#336699"><bean:write property="cnclInd" name="onDemandFlightInquiryForm" /></font>&nbsp;&nbsp;&nbsp;&nbsp;
...
<!-- On Demand Changes Begin -->
					...
					<tr>
						...
						<td align="left" style="padding-left:18px;"><html:text size="10" property="flightNum" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;"/></td>

						<td align="left" style="padding-left:2px;padding-right:2px;"><html:text property="depDate" size="14" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;"/></td>

						<td align="left" style="padding-left:6px;padding-right:1px;"><html:text property="boardPoint" size="6" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>

						<td align="left" style="padding-left:6px;padding-right:1px;"><html:text property="offPoint" size="6" name="onDemandFlightInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>

						<td align="left" style="padding-left:8px;padding-left:6px;"><html:text property="class1" size="6" name="onDemandFlightInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>

						<td align="left" ><html:text property="bookedClass" size="3" name="onDemandFlightInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>

						<td align="left" ><html:text property="flownClass" size="3" name="onDemandFlightInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>			

						<td align="left" ><html:text property="type" size="3" name="onDemandFlightInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>

						<td align="center"><html:text property="conFrom1" size="5" name="onDemandFlightInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>

						<td align="center"><html:text property="conFrom2" size="5" name="onDemandFlightInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>

						<td align="center"><html:text property="conTo1" size="5" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>

						<td align="center"><html:text property="conTo2" size="5" name="onDemandFlightInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						
<!-- 	On Demand changes begin -->
						<td align="center"><html:text property="timeStamp" size="22" name="onDemandFlightInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
		...
		<tr style="padding-top:10px;padding-left:16px;"><td colspan="11"><table align="left" border="0" width="98%">
			...
			<tr>
				...
				<td align="left" valign="top" style="padding-left:15px;"><html:text property="pnr" size="10" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>

				<td colspan="2"  valign="top" style="padding-left:17px;"><html:text property="pnrCreateDate" size="14" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>

				<td colspan="2"  valign="top" style="padding-left:8px;"><html:text property="ticketNumber" size="14" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>

				<td colspan="2"  valign="top" style="padding-left:15px;"><html:text property="ticketIssueDate" size="14" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>

				<td valign="top" style="padding-left:15px;"><html:text property="checkinDate" size="12" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>

				<td valign="top" style="padding-left:15px;"><html:text property="checkinTime" size="12" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>

				<td valign="top" style="padding-left:15px;"><html:text property="onBoardDate" size="12" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>

				<td valign="top" style="padding-left:15px;"><html:text property="onBoardTime" size="12" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
			...
			<tr>
				...
				<td valign="top" style="padding-left:15px;"><html:text property="frequentFlierAirline" size="10" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>

				<td valign="top" style="padding-left:18px;padding-right:10px"><html:text property="frequentFlierId" size="14" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>

				<td valign="top" colspan="2" align="left" style="padding-left:5px;padding-right:10px"><html:text property="frequentFlierTier" size="30" name="onDemandFlightInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				...
				<logic:present name="onDemandFlightInquiryForm" property="remList">

				<logic:notEmpty name="onDemandFlightInquiryForm" property="remList">		

				<td colspan="7" align="left" style="padding-left:5px;">

				<table class="filter"><logic:iterate name="onDemandFlightInquiryForm" property="remList" id="remList">
				...
				<logic:notPresent name="onDemandFlightInquiryForm" property="remList">
	...
	<html:hidden property="selSeqNum" name="onDemandFlightInquiryForm" />

	<html:hidden property="selLegOrigApCode" name="onDemandFlightInquiryForm"/>

	<html:hidden property="selRowSeat" name="onDemandFlightInquiryForm"/>

	<html:hidden property="selPnr" name="onDemandFlightInquiryForm"/>

	<html:hidden property="selPassenger" name="onDemandFlightInquiryForm"/>

	<html:hidden property="rowSelected" name="onDemandFlightInquiryForm" value="false" />
	
	<html:hidden property="seltimeStampString" name="onDemandFlightInquiryForm" /> 
	

	<html:hidden property="download" name="onDemandFlightInquiryForm" value="false" />
...
<!-- on demand begins -->
<!-- 		<logic:messagesPresent property="timeStamp"><script>document.forms[0].timeStamp.focus();</script></logic:messagesPresent>  -->
	<!-- on demand begins -->
	...
	<!--for printing of scroll List-->
	 ...
	 <div id="printListArea" style="width:100%;display:none;">	
		...
		<display:table name="onDemandFlightInquiryForm.selectList" requestURI="/SPLJ/OnDemandFlightInquirySubmit.do" cellpadding="0" cellspacing="1" style="text-align:center; width:100%; background-color: #FFFFFF;font-size: 6pt;" decorator="com.delta.SPLJ.decorators.SPLdecorator"> 
...
<!-- on demand changes begin -->
	   	 <!--        <display:column property="timeStamp" 			sortable="true" 	titleKey="spl.default.header.field.TimeStamp" 				style="text-align:center;width:6%;padding-right:2px;font-size:8pt;"/>  --> 
	 <!-- on demand changes end -->
	...
	<logic:notEmpty name="onDemandFlightInquiryForm" property="selectList">		

	<logic:notEqual property="selPassenger" value="" name="onDemandFlightInquiryForm">
	...
	//			var ts = tr[cnt].getElementsByTagName("td")[15].innerText;
				
				if ((passenger== document.forms[0].selPassenger.value)&&(row==document.forms[0].selRowSeat.value)){//}&&(ts==document.forms[0].selTimeStamp.value )){
...
<center>
<tiles:insert attribute="OnDemandSearchWindow" />
</center>
	</logic:notEqual>

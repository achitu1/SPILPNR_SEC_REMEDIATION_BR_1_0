...
<div id="scrollListArea" class="printstart">				
	...
	<div align=left><bean:write property="pnrCount" name="OnDemandSsrInquiryForm"/>&nbsp;rows returned.</div>

	<div id="tableContainer" style="overflow-y:auto;height:227px; width:100%;border:1px solid #B1B4C5;" class="printstart">

		<display:table name="OnDemandSsrInquiryForm.selectList" class="listTable" requestURI="/SPLJ/OnDemandSsrInquiryList.do" id="scrollTable" cellpadding="0" cellspacing="1" style="text-align:center; width:100%; background-color: #FFFFFF;" 
...
<div id="printListArea" style="width:100%;display:none;">	
	...
	<display:table name="OnDemandSsrInquiryForm.selectList" requestURI="/SPLJ/OnDemandSsrInquiryRowSelected.do" cellpadding="0" cellspacing="1" style="text-align:center; width:100%; background-color: #FFFFFF;font-size: 6pt;" decorator="com.delta.SPLJ.decorators.SPLdecorator"> 
    ...
    <display:setProperty name="locale.provider" value="org.displaytag.localization.I18nStrutsAdapter"/> 
			...
			<display:column property="localDepartureDate" 	sortable="true" 	titleKey="spl.default.header.field.localDepartureDate" 		style="text-align:center;width:10%;padding-right:2px;"/>  
		  	...
		  	<display:column property="timeStamp"  			sortable="true"  	titleKey="spl.default.header.field.TimeStamp" 				style="text-align:left;width:5%;padding-right:2px;"/> 
...
<logic:notEqual property="selPassenger" value="" name="OnDemandSsrInquiryForm">

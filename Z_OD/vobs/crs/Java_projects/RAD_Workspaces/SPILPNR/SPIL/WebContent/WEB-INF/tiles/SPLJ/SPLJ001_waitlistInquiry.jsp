...
function changeToUpper(obj){
  ...
  function resetThis(){
		...
		document.forms[0].airlineCode.value="";	
  		...
  		document.forms[0].action="<%=contextPath%>/SPLJ/WaitlistInquiry.do"	               
...
document.forms[0].action="<%=contextPath%>/SPLJ/WaitlistInquirySubmit.do"	
document.forms[0].submit();
}
</script>
</head>
...
<table width="950" cellpadding="0" cellspacing="0" border="0">
	...
	<logic:equal property="rowSelected" value="true" name="waitlistInquiryForm">
	<tr><td align="right">
		...
		<logic:equal name="waitlistInquiryForm" property="flagList" value="true">	
...
<logic:present name="waitlistInquiryForm" property="selectList">
<logic:empty name="waitlistInquiryForm" property="selectList">
<font color="red">DL SPILs from 03/09/2011 through current (Cancel SPILs from 09/23/2012) &nbsp;&nbsp;&nbsp; NW SPILs Thru 01/30/2010</font>				
...
<logic:notEmpty name="waitlistInquiryForm" property="selectList">
	...
	<bean:write property="pnrCount" name="waitlistInquiryForm"/>&nbsp;rows returned.
<div id="tableContainer" style="overflow:auto; height:230px; width:100%;border:1px solid #B1B4C5;">	

		<display:table name="waitlistInquiryForm.selectList" class="listTable" requestURI="/SPLJ/WaitlistInquirySubmit.do" id="scrollTable" cellpadding="0" cellspacing="1" style="text-align:center; width:100%; background-color: #FFFFFF;" decorator="com.delta.SPLJ.decorators.SPLdecoratorWaitlist"> 
...
<table border="0" width="100%" style="text-align:center;" cellpadding="0" cellspacing="0" class="sub_table">
			...
			<tr style="padding-top:10px;">
				...
				<b>	<bean:message key="spl.selected.field.SEAT" /> : <font color="#336699"><bean:write property="selRowSeat" name="waitlistInquiryForm" /></font>&nbsp;&nbsp;&nbsp;&nbsp;
				<bean:message key="spl.selected.field.PASSENGER" /> : <font color="#336699"><bean:write property="selPassenger" name="waitlistInquiryForm" /></font>&nbsp;&nbsp;&nbsp;&nbsp;
				<bean:message key="spl.selected.field.CUST_ID" /> : <font color="#336699"><bean:write property="customerID" name="waitlistInquiryForm" /></font>&nbsp;&nbsp;&nbsp;&nbsp;
				<bean:message key="spl.selected.field.CNCLIND" /> : <font color="#336699"><bean:write property="cnclInd" name="waitlistInquiryForm" /></font>
			</b></td>
			</tr>	
		...
		<tr style="padding-top:10px;padding-left:16px;">
			<td colspan="11" >
				<table align="left" border="0" width="98%">
					...
					<tr>
						<td align="left" style="padding-left:18px;"><html:text size="10" property="flightNum" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;"/></td>
						<td align="left" style="padding-left:2px;padding-right:2px;"><html:text property="depDate" size="14" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;"/></td>
						<td align="left" style="padding-left:6px;padding-right:1px;"><html:text property="boardPoint" size="6" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>
						<td align="left" style="padding-left:6px;padding-right:1px;"><html:text property="offPoint" size="6" name="waitlistInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="left" style="padding-left:8px;padding-left:6px;"><html:text property="class1" size="6" name="waitlistInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="left" ><html:text property="bookedClass" size="3" name="waitlistInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="left" ><html:text property="flownClass" size="3" name="waitlistInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>			
						<td align="left" ><html:text property="type" size="3" name="waitlistInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="center"><html:text property="conFrom1" size="5" name="waitlistInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="center"><html:text property="conFrom2" size="5" name="waitlistInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
						<td align="center"><html:text property="conTo1" size="5" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>
						<td align="center"><html:text property="conTo2" size="5" name="waitlistInquiryForm" readonly="true"  style="background-color:#DAD9D6;" /></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr style="padding-top:10px;padding-left:16px;"><td colspan="11"><table align="left" border="0" width="98%">
			...
			<tr>
				<td align="left" valign="top" style="padding-left:15px;"><html:text property="pnr" size="10" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>
				<td colspan="2"  valign="top" style="padding-left:17px;"><html:text property="pnrCreateDate" size="14" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>
				<td colspan="2"  valign="top" style="padding-left:8px;"><html:text property="ticketNumber" size="14" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;" /></td>
				<td colspan="2"  valign="top" style="padding-left:15px;"><html:text property="ticketIssueDate" size="14" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				<td valign="top" style="padding-left:15px;"><html:text property="checkinDate" size="12" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				<td valign="top" style="padding-left:15px;"><html:text property="checkinTime" size="12" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
					<td valign="top" style="padding-left:15px;"><html:text property="onBoardDate" size="12" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				<td valign="top" style="padding-left:15px;"><html:text property="onBoardTime" size="12" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
			</table></td></tr>
			...
			<tr>
				<td valign="top" style="padding-left:15px;"><html:text property="frequentFlierAirline" size="10" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				<td valign="top" style="padding-left:18px;padding-right:10px"><html:text property="frequentFlierId" size="14" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				<td valign="top" colspan="2" align="left" style="padding-left:5px;padding-right:10px"><html:text property="frequentFlierTier" size="30" name="waitlistInquiryForm" readonly="true" style="background-color:#DAD9D6;"  /></td>
				...
				<logic:present name="waitlistInquiryForm" property="remList">
				<logic:notEmpty name="waitlistInquiryForm" property="remList">		
				<td colspan="7" align="left" style="padding-left:5px;">
				<table class="filter"><logic:iterate name="waitlistInquiryForm" property="remList" id="remList">
				...
				<logic:notPresent name="waitlistInquiryForm" property="remList">
				<td colspan="7" align="left" style="padding-left:5px;">
				<table class="filter">
...
<html:hidden property="selPnr" name="waitlistInquiryForm"/>
<html:hidden property="rowSelected" name="waitlistInquiryForm" value="false" />
<html:hidden property="selPassenger" name="waitlistInquiryForm"/>
<html:hidden property="selAirlineCode" name="waitlistInquiryForm"/>
<html:hidden property="selDepartureDate" name="waitlistInquiryForm"/>
<html:hidden property="selFlightNumber" name="waitlistInquiryForm"/>
<html:hidden property="selWaitlistNum" name="waitlistInquiryForm"/>
<html:hidden property="flagLookup" name="waitlistInquiryForm" value="false" />
<html:hidden property="download" name="waitlistInquiryForm" value="false" />
</div>
...
<html:hidden property="selRowSeat" name="waitlistInquiryForm" value="" />
<logic:equal property="selRowSeat" value="false" name="waitlistInquiryForm">
	<script> 
		alert("Passenger <bean:write property='selPassenger' name='waitlistInquiryForm'/> was not located on the selected flight.");
...
<!-- for scroll List printing -->	
	<div id="printListArea" style="width:100%;display:none;">	
		<display:table name="waitlistInquiryForm.selectList" requestURI="/SPLJ/WaitlistInquirySubmit.do" cellpadding="0" cellspacing="1" style="text-align:center; width:100%; background-color: #FFFFFF;font-size: 6pt;" decorator="com.delta.SPLJ.decorators.SPLdecorator"> 
	    <display:setProperty name="locale.provider" value="org.displaytag.localization.I18nStrutsAdapter"/> 
		    <display:column property="airlineCode"			 		sortable="true" 	titleKey="spl.default.header.field.airline" 			style="text-align:center;padding-right:5px;"/>  
...
<logic:equal name="waitlistInquiryForm" property="flagLookup" value="true">
<script>
var url = "/SPLJ/PassengerList.do"
...
document.forms[0].submit();
	...
	<logic:present name="waitlistInquiryForm" property="selectList">
	<logic:notEmpty name="waitlistInquiryForm" property="selectList">		
	<logic:notEqual property="selPassenger" value="" name="waitlistInquiryForm">
		<script>
		function scroll(){

 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class SPLJ001_FrequentFlierInquiryAction extends Action {
	public ActionForward execute(
		...
		throws Exception {
			...
			Logger.log(this.getClass(), Logger.LEVEL_DEBUG, "-----FrequentFlierInquiryAction-------");	
			SPLJ001_FrequentFlierInquiryForm frm = (SPLJ001_FrequentFlierInquiryForm) form;
			...
			try {
				...
				try{
					...
					if(frm.getRowSelected().equals("true")){
							...
							//02/11/2011 by Hari
							detailList=spljBean.call_selected_record_lookup(localDepartureDate, opalCde, flightNumber, legOrigApCode, seqNum, rowSeat, pnrNum );
							...
							//02/11/2011 by Hari
							ArrayList remList = spljBean.call_selected_record_remarks_lookup(localDepartureDate, opalCde, flightNumber, legOrigApCode, seqNum, rowSeat,pnrNum );

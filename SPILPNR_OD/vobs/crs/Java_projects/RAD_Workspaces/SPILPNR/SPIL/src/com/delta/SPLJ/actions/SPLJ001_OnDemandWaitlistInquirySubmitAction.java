...
public class SPLJ001_OnDemandWaitlistInquirySubmitAction extends Action {
	...
	public ActionForward execute(
		...
		if (validateWaitlistInquiryForm(frm, request)) {
			...
			try {
				...
				selectList = spljBean.call_waitlist_inquiry_lookup_OD(airlineCode, flightNumber, localDepartureDate,	passengerName, pnrLocator, timeStamp);
	...
	private boolean validateWaitlistInquiryForm(
		...
		SPLJ001_OnDemandWaitlistInquiryForm frm,

...
public class PNRJ002_LookupOrigDestSubmitAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, 
			...
			frm.setPnrList(null);
			Logger.log(PNRJ002_LookupOrigDestSubmitAction.class, Logger.LEVEL_DEBUG, "Start of execute in PNRJ002_LookupOrigDestSubmitAction");
			ActionErrors errorException = new ActionErrors();
			ActionErrors errors = new ActionErrors();
			String link = "success";
			Logger.log(PNRJ002_LookupOrigDestSubmitAction.class, Logger.LEVEL_DEBUG, "In OriginDestSubmitAction");
			Logger.log(PNRJ002_LookupOrigDestSubmitAction.class, Logger.LEVEL_DEBUG, "Origin is:" + frm.getOrigin());
			Logger.log(PNRJ002_LookupOrigDestSubmitAction.class, Logger.LEVEL_DEBUG, "Travel Date is:" + frm.getTravelDate());

			// format Travel Date
			frm.setTravelDate(PNRJUtil.formatDate(frm.getTravelDate()));
			Logger.log(PNRJ002_LookupOrigDestSubmitAction.class, Logger.LEVEL_DEBUG, "Formatted Travel Date = [" + frm.getTravelDate() + "]");
			...
			*/	 
			...
			try{
				...
				Logger.log(PNRJ002_LookupOrigDestSubmitAction.class, Logger.LEVEL_ERROR, e.getMessage());

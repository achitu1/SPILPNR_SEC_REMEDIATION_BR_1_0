...
public class PNRJ002_OnDemandLookupOrigDestAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, 
			...
			Logger.log(PNRJ002_OnDemandLookupOrigDestAction.class, Logger.LEVEL_DEBUG, "Start of execute in PNRJ002_LookupOrigDestAction");
			...
			try{
				...
				Logger.log(PNRJ002_OnDemandLookupOrigDestAction.class, Logger.LEVEL_ERROR, e.getMessage());

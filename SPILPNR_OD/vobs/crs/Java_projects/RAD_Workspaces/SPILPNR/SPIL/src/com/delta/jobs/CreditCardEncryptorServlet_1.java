 ...
 */
public class CreditCardEncryptorServlet_1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static  boolean isJobStarted;
	private static String PROPERTY_FILE_NAME = "TPNRCCIx_1.txt";
	private static String UNIQUE_CC_FILE= "TPNRUNQCCIx_1.txt";
...
//	static BufferedWriter bufferedWriter = null;
	 ...
	 */
	public CreditCardEncryptorServlet_1() {
		super();
	}
...
//				}else 
				if(request.getRemoteHost().equals("mspj8103148.delta.rl.delta.com")){
					...
					Logger.log(CreditCardEncryptorServlet_1.class, Logger.LEVEL_ERROR, "Endpoint is null for the host IP:"+request.getRemoteHost());
				...
				while ((line = input.readLine()) != null) {
					...
					if(count ==1000){
						...
						CreditCardEncryptorServlet_1.getEncryptedCC(list,"SPL",endpointUrl);
						count =0;
		...
		out.println("<form method='POST' action='CreditCardEncryptorServlet_1?action=start'>");
	
	//	out.println("<form method='POST' action='CreditCardEncryptorServlet_1?action=stop'>");
...
public static void getEncryptedCC(List<String> creditCards, String userId, String endpointUrl) throws Exception{
		...
		if(serviceResponse !=null){
			if(serviceResponse.getLookupArrayOfTokensResult() != null && serviceResponse.getLookupArrayOfTokensResult().getStatusList() != null 
				...
				Logger.log(CreditCardEncryptorServlet_1.class, Logger.LEVEL_INFO, serviceResponse.getLookupArrayOfTokensResult().getRawTraceText());

...
public class PNRJ002_LookupPassengerSubmitAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, 
			...
			frm.setPnrList(null);
			Logger.log(PNRJ002_LookupPassengerSubmitAction.class, Logger.LEVEL_DEBUG, "Start of execute in PNRJ002_LookupPassengerSubmitAction");
			ActionErrors errorException = new ActionErrors();
			ActionErrors errors = new ActionErrors();
			String link = "success";
			Logger.log(PNRJ002_LookupPassengerSubmitAction.class, Logger.LEVEL_DEBUG, "In LookupPassengerSubmitAction");
			Logger.log(PNRJ002_LookupPassengerSubmitAction.class, Logger.LEVEL_DEBUG, "Passenger Name is:" + frm.getPassengerName());
			Logger.log(PNRJ002_LookupPassengerSubmitAction.class, Logger.LEVEL_DEBUG, "Travel Date is:" + frm.getTravelDate());
			
			// format Travel Date
			frm.setTravelDate(PNRJUtil.formatDate(frm.getTravelDate()));
			Logger.log(PNRJ002_LookupPassengerSubmitAction.class, Logger.LEVEL_DEBUG, "Formatted Travel Date = [" + frm.getTravelDate() + "]");
			
//			if(frm.getPassengerName() != null && frm.getPassengerName().length()< 3){
//				errors.add(ActionErrors.GLOBAL_ERROR, new ActionError("spl.passenger.minlength.PASSENGERNAME"));	
...
//			}			
			...
			*/	 
			...
			try{
				...
				Logger.log(PNRJ002_LookupPassengerSubmitAction.class, Logger.LEVEL_DEBUG, "calling ejb for passenger");
				...
				Logger.log(PNRJ002_LookupPassengerSubmitAction.class, Logger.LEVEL_ERROR, e.getMessage());

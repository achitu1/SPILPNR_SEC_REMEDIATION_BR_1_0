...
public class PNRJ002_LookupDefaultAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, 
			...
			Logger.log(PNRJ002_LookupDefaultAction.class, Logger.LEVEL_DEBUG, "Start of execute in PNRJ002_LookupDefaultAction");
		...
		//	boolean userinADNoCreditAccs = request.isUserInRole("queryonly"); //to see if this user is in a view-credit-field role
			...
			try{
				...
				Logger.log(PNRJ002_LookupDefaultAction.class, Logger.LEVEL_ERROR, e.getMessage());
				errorException.add(ActionErrors.GLOBAL_MESSAGE, 

...
public class PNRJ002_OnDemandLookupPassengerRedisplayAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, 
			...
			Logger.log(PNRJ002_OnDemandLookupPassengerRedisplayAction.class, Logger.LEVEL_DEBUG, "Start of execute in PNRJ002_OnDemandLookupPassengerRedisplayAction");
			...
			Logger.log(PNRJ002_OnDemandLookupPassengerRedisplayAction.class, Logger.LEVEL_DEBUG, "Formatted Travel Date = [" + frm.getTravelDate() + "]");
			...
			*/	 
			...
			try{
				...
				Logger.log(PNRJ002_OnDemandLookupPassengerRedisplayAction.class, Logger.LEVEL_DEBUG, "calling ejb for passenger");
				...
				Logger.log(PNRJ002_OnDemandLookupPassengerRedisplayAction.class, Logger.LEVEL_ERROR, e.getMessage());

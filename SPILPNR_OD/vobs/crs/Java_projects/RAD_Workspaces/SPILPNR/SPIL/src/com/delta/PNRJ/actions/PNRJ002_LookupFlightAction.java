...
public class PNRJ002_LookupFlightAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, 
			...
			Logger.log(PNRJ002_LookupFlightAction.class, Logger.LEVEL_DEBUG, "Start of execute in PNRJ002_LookupFlightAction");
			...
			/*catch (NamingException ne) {
				Logger.log(PNRJ002_LookupFlightAction.class, Logger.LEVEL_ERROR, 
				...
				Logger.log(PNRJ002_LookupFlightAction.class, Logger.LEVEL_ERROR, dbe.getMessage());
				...
				Logger.log(PNRJ002_LookupFlightAction.class, Logger.LEVEL_ERROR, e.getMessage());
				errorException.add(ActionErrors.GLOBAL_ERROR, 
				new ActionError("string.message"));
				saveErrors(request, errorException);
				link="failure";

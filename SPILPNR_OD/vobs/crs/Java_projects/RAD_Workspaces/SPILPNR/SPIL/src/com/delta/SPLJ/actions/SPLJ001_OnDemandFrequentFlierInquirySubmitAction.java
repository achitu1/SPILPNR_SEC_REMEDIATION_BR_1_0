...
public class SPLJ001_OnDemandFrequentFlierInquirySubmitAction extends Action {
	...
	public ActionForward execute(
		...
		SPLJ001_OnDemandFrequentFlierInquiryForm frm =

			(SPLJ001_OnDemandFrequentFlierInquiryForm) form;
		...
		try {
			...
			selectList =
				...
				spljBean.call_frequent_flier_inquiry_lookup_OD(

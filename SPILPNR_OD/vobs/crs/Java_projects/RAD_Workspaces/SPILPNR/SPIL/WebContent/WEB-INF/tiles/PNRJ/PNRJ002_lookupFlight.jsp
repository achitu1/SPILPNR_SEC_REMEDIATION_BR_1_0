	  ...
	  if (document.getElementById(tableId) != null){
	    ...
	    for (i=0; i < rows.length; i++) {
	        ...
	        rows[i].onclick = function(i) {
				...
				document.forms[0].action='<%=contextPath%>/PNRJ/LookupFlightDetailShow.do';
...
<logic:notEmpty name="lookupFlightForm" property="pnrTextList">

<div id="printArea" style="display: none; margin-right: -20px; margin-left: -20px">
 <table width="100%" border="0">
 	 <logic:iterate id="list" property="pnrTextList" name="lookupFlightForm">				
...
<logic:notEmpty name="lookupFlightForm" property="pnrList"> 
			...
			<tr class="row1_left_nopoint">
			  <td colspan="8">
				...
				<table width="950" border="0">
		          <bean:define id="A" name="lookupFlightForm" property="airlineCode" type="java.lang.String"/>
		          <bean:define id="F" name="lookupFlightForm" property="flightNumber" type="java.lang.String"/>
		          <bean:define id="T" name="lookupFlightForm" property="travelDate" type="java.lang.String"/>
		          <bean:define id="P" name="lookupFlightForm" property="passengerName" type="java.lang.String"/>
		          <bean:define id="O" name="lookupFlightForm" property="origin" type="java.lang.String"/>
		          <bean:define id="D" name="lookupFlightForm" property="destination" type="java.lang.String"/>
		 		  <logic:iterate id="list" property="pnrList" name="lookupFlightForm">
		          ...
		          <bean:define id="pnrCrtnDate" name="list" property="pnrCrtnDate" type="java.lang.String"/>
	  			  ...
	  			  onclick="location.href='LookupFlightDetailShow.do?selPnrLoctrNum=<%=pnrLoctrNum%>&selPnrCrtnDate=<%=pnrCrtnDate%>&airlineCode=<%=A%>&flightNumber=<%=F%>&travelDate=<%=T%>&passengerName=<%=P%>&origin=<%=O%>&destination=<%=D%>'">
		...
		<td align="right">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td><html:img border="0" onclick="location.href='LookupFlight.do'" style="cursor:hand;" page="/images/tab_fnlu_on.gif"/></td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr valign="top">
                ...
                <td width="672" align="center" valign="middle">
                	<html:form action="/PNRJ/LookupFlightSubmit.do" focus="airlineCode" onsubmit="checkDateFormat();prefillFlightNum();clearSelected();">
					<html:hidden name="lookupFlightForm" property="loctrNum"/>
					<html:hidden name="lookupFlightForm" property="crtnDate"/>
					<html:hidden name="lookupFlightForm" property="travelDateSort"/>
					<html:hidden name="lookupFlightForm" property="mkAlCode"/>
					<html:hidden name="lookupFlightForm" property="fltNum"/>
					<html:hidden name="lookupFlightForm" property="segOrigApCode"/>
					<html:hidden name="lookupFlightForm" property="segDestApCode"/>
					<html:hidden name="lookupFlightForm" property="psngrNme"/>
					<html:hidden name="lookupFlightForm" property="invClCode"/>
					<html:hidden name="lookupFlightForm" property="segStatusCode"/>
					<html:hidden name="lookupFlightForm" property="showRedisplay"/>
					<html:hidden property="selPnrCrtnDate" name="lookupFlightForm"/>
					<html:hidden property="selPnrLoctrNum" name="lookupFlightForm"/>
					<html:hidden property="selPassenger" name="lookupFlightForm"/>
					<html:hidden property="selFlightNumber" name="lookupFlightForm"/>
					
					
					<table width="650" align="center" class="filter" border="0">
						<!-- flight number filter start -->
						<tr>
							<td>
								<div id="flight">
								<table border="0">
									<tr>
										<td width="150" align="right">
											<logic:messagesPresent property="airlineCode">
												<font color="red"><bean:message key="pnr.flightlookup.filter.field.AIRLINECODE"/></font>
											</logic:messagesPresent>
											<logic:messagesNotPresent property="airlineCode">
												<bean:message key="pnr.flightlookup.filter.field.AIRLINECODE"/>
											</logic:messagesNotPresent>
										</td>
										<td width="2"><font color="red">*</font></td>
										<td align="left" width="36">
											<html:text property="airlineCode" maxlength="2" size="5" tabindex="1" onkeyup="javascript:changeToUpper(this);" />
										</td>

										<td align="right" width="86">
											<logic:messagesPresent property="flightNumber">
												<font color="red"><bean:message key="pnr.flightlookup.filter.field.FLIGHTNUMBER"/></font>
											</logic:messagesPresent>
											<logic:messagesNotPresent property="flightNumber">
												<bean:message key="pnr.flightlookup.filter.field.FLIGHTNUMBER"/>
											</logic:messagesNotPresent>
										</td>
										<td width="3"><font color="red">*</font></td>
										<td align="left" width="25">
											<html:text property="flightNumber" maxlength="4" size="5" tabindex="2" onblur="prefillFlightNum()"/>
										</td>

										<td align="right" width="86"><span>
											<logic:messagesPresent property="travelDate">
												<font color="red"><bean:message key="pnr.flightlookup.filter.field.TRAVELDATE"/></font>
											</logic:messagesPresent>
											<logic:messagesNotPresent property="travelDate">
												<bean:message key="pnr.flightlookup.filter.field.TRAVELDATE"/>
											</logic:messagesNotPresent>
											</span>
										</td>
										<td width="14"><font color="red">*</font></td>
										<td align="left" colspan="7" width="222">
											<html:text property="travelDate" maxlength="10" size="10" tabindex="3" onblur="checkDateFormat()"/> (MM/DD/YYYY)
										</td>
									</tr>
									<tr>
										<td width="150" align="right"><bean:message key="pnr.flightlookup.filter.field.PASSENGERNAME"/></td>
										<td width="2"></td>
										<td align="left" colspan="4">
											<span title="<bean:message key="pnr.general.label.passengerName"/>">
											<html:text property="passengerName" maxlength="25" size="40" tabindex="4" onkeyup="javascript:changeToUpper(this);" />
											</span> 
										</td>

										<td align="right" width="86"><bean:message key="pnr.flightlookup.filter.field.ORIGIN"/></td>
										<td width="14"></td>
										<td align="left">
											<html:text property="origin" maxlength="3" size="5" tabindex="5" onkeyup="javascript:changeToUpper(this);" />
										</td>

										<td align="right"><bean:message key="pnr.flightlookup.filter.field.DESTINATION"/></td>
										<td></td>
										<td align="left" width="108">
											<html:text property="destination" maxlength="3" size="5" tabindex="6" onkeyup="javascript:changeToUpper(this);" />
										</td>
									</tr>
								</table>
								</div>
								...
								<table width="650" align="center" class="filter" >
								  <tr>
									...
									<td width="250" align="left">
										<img src="<%=request.getContextPath()%>/images/clear_button.gif" border="0" style="cursor:hand;" onclick="location.href='LookupFlight.do'" tabindex="8">
										<%--html:img border="0" page="/images/clear_button.gif" style="cursor:hand;" onclick="location.href='LookupFlight.do'"/--%>
									</td>
									<td width="70"></td>
								  </tr>
								</table>
...
<!-- list start -->
	...
	<td align="left" >
	    <font color="red">DL PNR's from 03/09/2011 to current (prior to 03/09/2011 PNRPUL) NW PNR's Thru 01/30/2010</font>
			...
			<td align="right">
				<bean:write property="over1000Lines" name="lookupFlightForm"  filter="false"/>
			</td>
	<td align="right">
	...
	<tr>
		<!--list header start-->
		<td>
		<bean:write property="pnrCount" name="lookupFlightForm"/>&nbsp;rows returned.
			<table width="100%" border="0" cellpadding="1" cellspacing="1" class="formTable">
			<tr class="subtable_header_bold">
		        <th width="70" align="left" valign="bottom"><html:link page="/PNRJ/LookupSortByFlight.do?sortBy=pnrLoctrNum" ><bean:message key="pnr.default.header.field.pnrNumber"/></html:link></th>
				<th width="90" align="center" valign="bottom"><html:link page="/PNRJ/LookupSortByFlight.do?sortBy=pnrCrtnDate" ><bean:message key="pnr.default.header.field.pnrCreationDate"/></html:link></th>
				<th width="80" align="center" valign="bottom"><html:link page="/PNRJ/LookupSortByFlight.do?sortBy=pnrTravelDate" ><bean:message key="pnr.default.header.field.travelDate"/></html:link></th>
				<th width="70" align="center" valign="bottom"><html:link page="/PNRJ/LookupSortByFlight.do?sortBy=pnrMkAlCode" ><bean:message key="pnr.default.header.field.airline"/></html:link></th>
				<th width="70" align="center" valign="bottom"><html:link page="/PNRJ/LookupSortByFlight.do?sortBy=pnrFltNum" ><bean:message key="pnr.default.header.field.flightNumber"/></html:link></th>
				<th width="70" align="center" valign="bottom"><html:link page="/PNRJ/LookupSortByFlight.do?sortBy=pnrSegOrigApCode" ><bean:message key="pnr.default.header.field.origin"/></html:link></th>
				<th width="70" align="center" valign="bottom"><html:link page="/PNRJ/LookupSortByFlight.do?sortBy=pnrSegDestApCode" ><bean:message key="pnr.default.header.field.destination"/></html:link></th>
				<th width="240" align="center" valign="bottom"><html:link page="/PNRJ/LookupSortByFlight.do?sortBy=pnrPsngrNme" ><bean:message key="pnr.default.header.field.passenger"/></html:link></th>
				<th width="70" align="center" valign="bottom"><html:link page="/PNRJ/LookupSortByFlight.do?sortBy=pnrInvClCode" ><bean:message key="pnr.default.header.field.classCode"/></html:link></th>
				<th width="70" align="center" valign="bottom"><html:link page="/PNRJ/LookupSortByFlight.do?sortBy=pnrSegStatusCode" ><bean:message key="pnr.default.header.field.segmentStatus"/></html:link></th>
				<th width="15"></th>
			</tr>
			<tr class="row1_left_nopoint">
			  <td colspan="11">
		...
		<td>
			...
			<tr class="row1_left_nopoint">
			  <td colspan="11">
				<div name="divTicket" style="overflow-y:auto; height:200px; width:100%;" >
				<!-- The row content start 
				<table width="100%" border="0" id="scrollTable" cellpadding="1" cellspacing="1"  class="formTable">
		 		  <logic:iterate id="list" property="pnrList" name="lookupFlightForm">
	  			  <tr class="row1" style="cursor:pointer">
	  			  	<td width="58" align="left" valign="bottom"><bean:write name="list" property="pnrLoctrNum"/></td>
					<td width="72" align="center" valign="bottom"><bean:write name="list" property="pnrCrtnDate"/></td>
					<td width="65" align="center" valign="bottom"><bean:write name="list" property="pnrTravelDate"/></td>
					<td width="65" align="center" valign="bottom"><bean:write name="list" property="pnrMkAlCode"/></td>
					<td width="65" align="center" valign="bottom"><bean:write name="list" property="pnrFltNum"/></td>
					...
					<td width="210" align="left" valign="bottom"><bean:write name="list" property="pnrPsngrNme"/></td>
...
<!--detail start -->
	...
	<td align="left" >
		...
		<td align="right">
			...
			<logic:equal name="lookupFlightForm" property="showRedisplay" value="true"> 
...
<logic:messagesPresent property="flightNumber">
	<script language="javascript">document.forms[0].flightNumber.focus();</script>
</logic:messagesPresent>

<logic:messagesPresent property="airlineCode">
	<script language="javascript">document.forms[0].airlineCode.focus();</script>
</logic:messagesPresent>

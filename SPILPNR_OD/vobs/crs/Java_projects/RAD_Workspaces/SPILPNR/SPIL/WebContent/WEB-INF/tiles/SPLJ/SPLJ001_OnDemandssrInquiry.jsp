...
<% 	String path = contextpath+"/PNRJ/OnDemandredirectApp.do";%>
	  ...
	  if (document.getElementById(tableId) != null){
	    ...
	    for (i=0; i < rows.length; i++) {
	        ...
	        rows[i].onclick = function(i) {
					...
					var tsstring=this.getElementsByTagName("td")[10].innerText;
				//	alert(tsstring);
				...
				//On-Demand end
					...
					document.forms[0].action="<%=contextPath%>/SPLJ/OnDemandSsrInquiryRowSelected.do"	               
...
function downloadSubmit(){
	...
	document.forms[0].action="<%=contextPath%>/SPLJ/OnDemandSsrInquiryList.do"	
...
function resetThis(){
	...
	document.forms[0].flightNumber.value="";
  	...
  	document.forms[0].action="<%=contextPath%>/SPLJ/OnDemandSsrInquiry.do";
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr align="right" height="30">
						...
						<td width="30%"><img
											src="<%=contextpath%>/images/spiltitleOnDemand.gif"
											border="0" />
										</td>
...
<br>
<center><b>-ON DEMAND-</b></center>
<html:form action="/SPLJ/OnDemandSsrInquiryList.do" method="post">

<html:hidden property="rowSelected" name="OnDemandSsrInquiryForm" value="false" />

<html:hidden property="selPassenger" name="OnDemandSsrInquiryForm"/>

<html:hidden property="selRowSeat" name="OnDemandSsrInquiryForm"/>

<html:hidden property="selPnr" name="OnDemandSsrInquiryForm"/>

<html:hidden property="selLegOrigApCode" name="OnDemandSsrInquiryForm"/>

<html:hidden property="selSeqNum" name="OnDemandSsrInquiryForm"/>

<html:hidden property="download" name="OnDemandSsrInquiryForm" value="false" />	
<!-- on demand changes begin -->
<html:hidden property="seltimeStampString" name="OnDemandSsrInquiryForm" /> 

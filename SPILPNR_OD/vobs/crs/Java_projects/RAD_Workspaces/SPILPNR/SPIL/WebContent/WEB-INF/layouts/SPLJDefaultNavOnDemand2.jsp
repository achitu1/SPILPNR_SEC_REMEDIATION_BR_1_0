...
<% 
	String path = contextpath+"/PNRJ/OnDemandRedirectApp.do"; %>	<!--spilPath=-->
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="right" width="70%">													<logic:present role="authorizedUsers">					<!-- 		<html:link href="< %=spilPath%>" target="_blank"> SPIL</html:link>&nbsp;|&nbsp; 		 -->								</logic:present> <logic:notPresent role="authorizedUsers">											 SPIL&nbsp;|&nbsp; 							</logic:notPresent>								<logic:present role="queryonly,querycc">
					<!-- 			<html:link href="<%=path%>" target="_blank"> PNR ON DEMAND</html:link>&nbsp;|&nbsp; 	 -->
					...
					<tr align="right" height="30">
						<!--  We need new image resource to display the title for SPIL on Demand-->						
						<td width="30%"><img src="<%=contextpath%>/images/spiltitleOnDemand.gif" border="0" /></td><!-- spiltitleOnDemand.gif -->
 </tr>
				</table>
				</td>
			</tr>

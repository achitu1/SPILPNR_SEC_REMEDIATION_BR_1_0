...
<table border=0 cellpadding=0 cellspacing=0 width=835 style='border-collapse:collapse;table-layout:fixed;width:628pt'>
	...
	<tr>
	   ...
	   <td colspan="13" align="center" class="xl28"><b><font size="3">Special Passenger Information List</font></b></td>
	...
	<tr>
       ...
       <td colspan="13" align="center" class="xl24">Download Date: <date:format pattern="MMM dd, yyyy"><date:currentTime/></date:format></td>
	...
	<tr style="font-weight:bold;text-align:center;">
       ...
       <td class="xl30">Fare Class</td>

       <td class="xl30">Booked Class</td>

       <td class="xl30">Flown Class</td>

	   <td class="xl30">Passenger Type</td>
	...
	<logic:iterate property="selectList" id="selectList" name="onDemandFlightInquiryForm">
